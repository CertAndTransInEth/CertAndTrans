...
```json
{
  ...
  "$template": {
    ...
    "url": "https://happy-euler-dc3ae9.netlify.app/"
  },
  "issuers": [
    {
      "name": "Demo Issuer",
      "documentStore": "0x2CD55759B92627A3eA6887F31b67216F88d8A785",
      "identityProof": {
        "type": "DNS-TXT",
        "location": "vivacious-amber-snipe.sandbox.openattestation.com"
      }
    }
  ],
  "recipient": {
