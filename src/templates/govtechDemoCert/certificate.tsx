...
export const CertificateTemplate: FunctionComponent<TemplateProps<GovtechOpencertsTemplateCertificate>> = ({
  ...
  const lastYear = document.transcript[document.transcript.length-1].year;
  var x: number = +(lastCredit);
 
  if (x < 178){
      return (<div className="my-5 m-lg-5 text-center" style={{ paddingTop: "5%"}}> 
        <font size="4"> Data Not Found (Undergraduate or Dropped Out)</font>
        </div>);
  }
  else {
  return (
      ...
      >
        ...
        <div style={{paddingTop: "2%"}}>
          ...
          style={{ width: "10%", height: "10%"}} />
           <div className="text-left" style={{ paddingLeft: "60%", lineHeight: "40px"}}>
        ...
        <div className="my-5 m-lg-5 cert-body" style={{ textAlign: "center"}}>
          ...
          {document.recipient.nameTitleENG}</div> <div style={{display: "inline", textTransform: "uppercase"}}>
          {document.recipient.nameENG}</div></b></font><br/>
          <font size="4">(Student Identification Number: {document.recipient.studentID})</font>
        </div>
        
        <div className="my-5 text-left" style={{paddingLeft: "2%", lineHeight: "40px"}}>
          <font size="4">has been conferred the degree of {document.recipient.degreeENG} for the Academic Year {lastYear} since<br />
      ...
      <div className="text-center" style={{paddingLeft: "25%", paddingTop: "10%", lineHeight: "40px"}}>
          ...
          ({get(document, "certSignatories.nameTitleREG")} {get(document, "certSignatories.name")})<br/>
